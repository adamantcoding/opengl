...
void main() {
    ...
    vec4 blendMapColor = texture(blendMap, output_textureCoords);
    float backTextureAmount = 1 - (blendMapColor.r + blendMapColor.g + blendMapColor.b);
    vec2 tiledCoords = output_textureCoords * 40;
    ...
    outputColor = vec4(totalDiffuse, 1.0) * totalColor + vec4(totalSpecular, 1.0);
